...
const Navbar = () => {
	...
	return (
		<nav
			ref={menuRef}
			className="bg-zinc-900 text-green-500 text-md hover:text-neutral-300 w-full fixed shadow-lg z-50"
		>
			<div className="max-w-screen-lg mx-auto justify-between md:items-center md:flex">
				<div className="flex justify-between">
					<a
						href="#home"
						className="transition ease-in-out hover:text-green-500 hover:-translate-y-1 duration-300 font-extrabold py-5 px-5 cursor-pointer"
					>
